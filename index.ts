...
export function getGradientFade(fadePercentage: number) {
...
export function getGradientAmberFade(fadePercentage: number) {
...
export function getGradientAcidFade(fadePercentage: number) {
