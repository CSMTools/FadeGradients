export function getGradient(type, fadePercentage) {
    if (type === 'Fade') {
...
export function getGradientFade(fadePercentage) {
...
export function getGradientAmberFade(fadePercentage) {
...
export function getGradientAcidFade(fadePercentage) {
...
export function isFade(paintIndex) {
    return [38, 522, 752, 1026].includes(paintIndex);
}
export function isAmberFade(paintIndex) {
    return [246, 523].includes(paintIndex);
}
export function isAcidFade(paintIndex) {
    return paintIndex === 253;
}
export function isBerriesAndCherries(paintIndex) {
    return paintIndex === 1002;
}
export function isAnyFade(paintIndex) {
    return isFade(paintIndex) || isAmberFade(paintIndex) || isAcidFade(paintIndex) || isBerriesAndCherries(paintIndex);
}
export function getFadeName(paintIndex) {
